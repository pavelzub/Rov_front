...
static const QList<QString> availableSlots = {"_manRotateRight", "_manRotateLeft", "_manOpen", "_manClose", "_axisXChange", "_axisYChange", "_axisZChange", "_axisWChange",
                                       "_camera1RotateRight", "_camera1RotateLeft", "_camera2RotateRight", "_camera2RotateLeft", "_magnetOn", "_magnetOff", "_acousticOn", "_acousticOff"};
static const QList<QString> rusNames = {"Ман. вправо", "Ман. влево ", "Ман. открыть", "Ман. закрыть", "Ось Х", "Ось Y", "Ось Z", "Ось W",
                                       "Камера1 вправо", "Камера1 влево", "Камера2 вправо", "Камера2 влево", "Включить магнит", "Выключить магнит", "Включить аккустику", "Выключить аккустику"};
